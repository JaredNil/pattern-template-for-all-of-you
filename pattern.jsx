...
Command . Паттерн предполагает прослойку между двумя абстракциями для оптимизации, эффективности кода.
Как пример в калькуляторе 3 абстракции: фронт, механизм вычислений, класс сохраняющий историю калькуля(command).
...
Strategy Имеется общий интерфейс. Функции стратегии описывают параметры конструктора
 для создания instances этого интерфейса.
